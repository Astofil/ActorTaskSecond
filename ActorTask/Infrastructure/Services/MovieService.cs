...
public class MovieService
{
    ...
    public async Task<PaginationResponse<List<GetMovieDto>>> GetMoviesByCategory(MovieFilter movieCategory)
    { 
        var find = await _context.Movies.ToListAsync();
        var list = new List<GetMovieDto>();
        ...
        return new PaginationResponse<List<GetMovieDto>>(mapped, totalRecords, movieCategory.PageSize, movieCategory.PageNumber);
    }
}
